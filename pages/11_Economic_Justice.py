...
def _run_one(scenario_key, n_samples, selected_biases, bias_intensity,
             ...
             is_health=False, algo="hist_gradient_boosting"):
  ...
  <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:.5rem">
    <div>
      <p style="font-family:'DM Mono',monospace;font-size:.65rem;letter-spacing:.18em;
        ...
        ECONOMIC JUSTICE · GAGS v1.0 · §25 · {preset_info.regulatory_body}
      </p>
        ...
        with st.spinner(f"Simulation {i + 1}/{n_runs}"):
            ...
            if r:
                ...
                save_to_history("econ_snapshot_history",
                                label=f"Run {i + 1}|fs={r['fairness_score']:.2f}|{getattr(preset_info, 'economic_domain', getattr(preset_info, 'health_domain', ''))}|{selected_algo}",
        ...
        📚 {bm.citation[:100]}…</p>
            ...
            with tab_map.get("\U0001f48a Health Financing", list(tab_map.values())[0]):
                ...
                pm = {
                    ...
                    "maternal": [
                        f"**Maternal access gap: {avg_mat_gap:.1%}** \u2014 FCT 2022 pilot showed 31% rural miss rate; AI trained on urban tertiary records",
            ...
            with tab_map.get("\U0001f4da Benchmarks", list(tab_map.values())[0]):
                ...
                health_bms = [
                    ...
                    ("FCT Maternal Health AI Pilot (2022)",
...
4. Mandate Hausa/Yoruba/Igbo interfaces for gig platforms""")
    ...
    # ── Welcome ────────────────────────────────────────────────────────────────
    st.markdown("## 💼 AI Equity & Impact Lab (AEIL)  — Research + Industry Edition")
...
st.markdown(
    ...
    "💼 ECONOMIC JUSTICE · GAGS v1.0 · §25 Economic Justice Engine · "
